...
namespace BlockBase.BBLinq.ExtensionMethods
{
    public static class TypeExtensionMethods
    {
        ...
        public static IEnumerable<PropertyInfo> GetPrimaryKeyProperties(this Type type, bool stopOnFirst = false)
        {
        ...
        {
            var primaryKeys = GetPrimaryKeyProperties(type, true) as List<PropertyInfo>;
        ...
        /// <returns>An enumerable of PropertyInfo</returns>
        public static IEnumerable<PropertyInfo> GetForeignKeyProperties(this Type type, bool stopOnFirst = false)
        {
            return GetPropertiesWithAttribute<ForeignKeyAttribute>(type, stopOnFirst);
        }
        ...
        {
            var primaryKeys = GetForeignKeyProperties(type, true) as List<PropertyInfo>;
            if (primaryKeys.Count > 0)
            {
                return primaryKeys[0];
            }
